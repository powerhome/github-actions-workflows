...
- `enhanced-cobra-test-plan`, using `claude-opus-5[effort=high]`.
...
The [design record](test-plans-design-record.md) captures the plan this action was built from, including the deferred private-source options.
